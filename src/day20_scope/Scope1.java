...
public class Scope1 {
	...
	public int sayi; // class'in icinde fakat main method'un disinda olusturulan
			  ...
			  // calss level'de olusturuldugu icin class'in her yerinden belli sartlarla kullanilabilir
			  // Intance variable'lar object'e bagli olarak calisir (ogretmen adi veya ogrenci notu gibi)
	...
	public static void main(String[] args) {
		...
		// System.out.println(sayi); // static olmayan bir variable'a sattic method icinden ulasamayiz
		...
		Scanner      scan      =           new             Scanner   (System.in); // bu javadaki obje olusturma formudur
