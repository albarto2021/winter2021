...
public class ArrayList05 {
	...
	public static void main(String[] args) {
		...
		List<Integer> list2=Arrays.asList(arr1); // [1, 2, 3]
		
		System.out.println(list2);
		
		// Bazen cok fazla elemani olan bir liste olusturmamiz gerekir
		// Bu durumda liste elemanlarini tek tek eklemek yerine
		// elemanlari bir Array'e ekler, sonra da array'i list2e cevirebiliriz
		// ornek bir web sitesinden tum urunleri bir listeye eklemek istedigimizde
		
		// Ancak bu method'la array'den cevirdigimiz list esnek olmaz.
		// (array'in ozelliklerini tasir), remove(), add(), clear() gibi uzunlugu etkileyen methodlar kullanilamaz
		// Java bu degisimdeki Array ve List'i senkronize eder, birinde yaptigimiz degisiklik
		// otomotik olarak digerini de update eder
