...
public class C6_StringBuilder01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("sb2 : " + sb2); // sb2 : Mehmet
		...
		System.out.println("sb3 kapasite " + sb3.capacity()); // 10 : basta 10 kapasite verdigimiz icin dolana kadar 10'u kullanir
		
		// capacity hafiza yonetimi icin cok onemli
		// kod yazilirken sabit uzunluk veya max.uzunluk belli ise 
		// 3. method ile olusturarak HAFIZA KULLANMINI optimize edebiliriz.
	}
}
