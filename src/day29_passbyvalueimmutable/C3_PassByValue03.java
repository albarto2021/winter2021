...
public class C3_PassByValue03 {
	...
	private static char[] forEachLoop;

	public static void main(String[] args) {
		/* 
		 Soru : Bir list olusturalim. Eleman olarak 10,11,12 ekleyelim. Iki method olusturup list elemanlarini artirmayi deneyelim
	...
	public static void degistirFor(List<Integer> list) {
		...
		for (Integer each : list) { // foreach loop ile listeyi guncellemiyoruz
									// daceve herbir elemai tek tek cagirip 3 fazilasini yazdirdik
			each+=3;
