...
public class C3_ArrayList02 {
	...
	public static void main(String[] args) {
		...
		// bir eleman nasi silinir
		
		list.remove(1); 		
		System.out.println(list); // [10, 8, 12, 20]
		
		System.out.println(list.remove(2)); // git 12'yi kaldir dedik, bize 12'yi döndür
		...
		// bize true dondurur, listede bulmazsa istegin yerine
		// getirilmedigini anlamamiz icin false dondurur
