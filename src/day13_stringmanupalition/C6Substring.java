...
public class C6Substring {
	...
	public static void main(String[] args) {
		...
		// 11.ci karalterden sonuna kadar olan Stringi yazdiralim
		...
		System.out.println(str.substring(10, 10)); // baslangýc indexi olsun der, ama bitis indexi
												   // olmasin der, Java son soyleneni yapar, son soylenen en gunceldir
		
		// System.out.println(str.substring(8, 7)); // RTE 
		
		System.out.println(str.substring(22)); // length()-1 -> son karakteri
		System.out.println(str.substring(23)); // length()   -> bos
		// System.out.println(str.substring(24)); // length()'den buyuk sayi yazarsak RTE
		
		// str'in ilk 10 karakteri * ile gizleyin, geriye kalanlar normal yazilsin
		
		String str3 = str.substring(0, 10); // str'nin ilk 10 karakterini al
